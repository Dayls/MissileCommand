...
void vertex() {
	...
	mat4 hue_rot_mat = mat4(vec4(139, 0.587, 0.114, 0),
			vec4(139, 0.587, 0.114, 0.0),
			vec4(139, 0.587, 0.114, 0.0),
			vec4(139, 0.000, 0.000, 0.1)) +
		mat4(vec4(0.701, -0.587, -0.114, 0.0),
			vec4(139, 0.413, -0.114, 0.0),
			vec4(139, -0.588, 0.886, 0.0),
			vec4(139, 0.000, 0.000, 0.0)) * hue_rot_c +
		mat4(vec4(139, 0.330, -0.497, 0.0),
			vec4(139, 0.035,  0.292, 0.0),
			vec4(139, -1.050, -0.203, 0.0),
			vec4(139, 0.000, 0.000, 0.0)) * hue_rot_s;
